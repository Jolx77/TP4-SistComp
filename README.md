...
1) checkinstall es una utilidad en sistemas Linux que se utiliza para instalar y administrar paquetes de software. Se utiliza principalmente para instalar software que se compila a partir del código fuente.
